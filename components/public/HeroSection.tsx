...
const STATS = [
  ...
  { value: "48 hr", label: "Express Turnaround" },
...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(155deg, #f5fbff 0%, #edf7fd 45%, #dff5f0 100%)",
      }}
    >
      {/* ── Background orbs ── */}
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(200,233,248,0.45) 0%, transparent 65%)",
          top: -160,
          right: -140,
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(62,203,154,0.14) 0%, transparent 65%)",
          bottom: 40,
          left: -80,
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(255,204,0,0.1) 0%, transparent 65%)",
          top: "40%",
          left: "38%",
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, #1a7fba18 1px, transparent 1px)",
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16 items-center w-full">
        ...
        <div ref={contentRef}>
          ...
          <p className="text-base font-medium text-[#4e6575] leading-relaxed mb-9 max-w-[420px]">
            Professional laundry &amp; dry-cleaning service with fast turnaround.
            We pick up, we clean, we deliver — so you don&apos;t have to lift a
            finger.
          </p>
          ...
          <div className="flex flex-wrap gap-3 mb-12">
            <a
              ...
              style={{
                background:
                  "linear-gradient(135deg, #2496d6 0%, #1a7fba 50%, #0f5a85 100%)",
                boxShadow: "0 8px 28px rgba(26,127,186,0.40)",
              }}
            >
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              borderRadius: 32,
              background:
                "linear-gradient(145deg, #c8e9f8 0%, #dff5eb 100%)",
              transform: "rotate(-8deg) translate(-18px, 14px)",
              boxShadow: "0 20px 50px rgba(26,127,186,0.14)",
            }}
          />
          {/* Middle card */}
          <div
            ...
            style={{
              ...
              borderRadius: 32,
              background:
                "linear-gradient(145deg, #edf7fd 0%, #f5fbff 100%)",
              transform: "rotate(-3deg)",
              boxShadow: "0 16px 40px rgba(26,127,186,0.10)",
          ...
          <div
            ...
            style={{
              ...
              background: "white",
              boxShadow:
                "0 28px 70px rgba(26,127,186,0.20), 0 4px 16px rgba(0,0,0,0.06)",
          ...
          >
            ...
            <div
              style={{
                ...
                boxShadow: "0 6px 18px rgba(26,127,186,0.14)",
              }}
            >
            ...
            <div className="text-center">
              ...
              <div className="text-xs font-semibold text-[#8ca0b0] mt-1">
              ...
              <div className="w-full h-2 rounded-full bg-[#edf7fd] overflow-hidden">
                <div
                  style={{
                    ...
                    width: "50%",
                    borderRadius: 999,
                    background: "linear-gradient(90deg, #2496d6, #1a7fba)",
                    animation: "barGrow 1.6s cubic-bezier(0.22,1,0.36,1) 0.8s both",
                  }}
                />
              </div>
            </div>
                ...
                <div key={step} className="flex flex-col items-center gap-1.5">
                  <div
                    style={{
                      ...
                      height: 28,
                      borderRadius: 9,
                      background: i < 2 ? "#1a7fba" : "#edf7fd",
                      border: `1.5px solid ${i < 2 ? "#1a7fba" : "#c8e9f8"}`,
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                    }}
            ...
            <div
              style={{
                width: "100%",
                background: "linear-gradient(135deg, #edf7fd, #dff5eb)",
                border: "1.5px solid #c8e9f8",
                borderRadius: 16,
                padding: "10px 14px",
                display: "flex",
            ...
            >
              <div>
                ...
                <div
                  ...
                  style={{ fontSize: 13, color: "#0f5a85", marginTop: 2 }}
                >
                  Today, 18:30
                </div>
              </div>
          ...
          <div
            ...
            style={{
              ...
              borderRadius: 16,
              padding: "8px 14px",
              boxShadow: "0 8px 24px rgba(26,127,186,0.16)",
              border: "1.5px solid #e0f0fa",
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span
                ...
                style={{ fontSize: 11, color: "#0f5a85" }}
              >
                Order Confirmed
              </span>
            </div>
          ...
          <div
            ...
            style={{
              ...
              borderRadius: 16,
              padding: "8px 14px",
              boxShadow: "0 8px 24px rgba(62,203,154,0.18)",
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span
                className="font-extrabold"
                style={{ fontSize: 11, color: "#1a7070" }}
              >
                Free delivery
              </span>
            </div>
