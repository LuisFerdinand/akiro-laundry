...
const CONTACT_ITEMS = [
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
        <path
          d="M3 5a2 2 0 0 1 2-2h3.28a1 1 0 0 1 .95.68l1.45 4.07a1 1 0 0 1-.23 1.04L8.5 10.5s1.45 3.3 5 5l1.7-1.97a1 1 0 0 1 1.04-.23l4.07 1.45a1 1 0 0 1 .69.95V19a2 2 0 0 1-2 2C8.16 21 3 12.84 3 5z"
          stroke="currentColor"
          strokeWidth="1.8"
  ...
  },
  {
    ...
    label: "Email Us",
    value: "hello@akirolaundry.tl",
    href: "mailto:hello@akirolaundry.tl",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    ...
    label: "Find Us",
    value: "Rua de Beloi, Dili, Timor-Leste",
    href: "https://maps.google.com/?q=Dili,Timor-Leste",
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    ...
    <section id="contact" className="py-24 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(145deg, #1a7fba 0%, #2496d6 50%, #0f5a85 100%)",
            boxShadow: "0 24px 70px rgba(26,127,186,0.45)",
          }}
        >
          {/* Orbs */}
          <div
          ...
          <div className="relative md:flex items-center justify-between gap-10">
            <div className="mb-8 md:mb-0">
              ...
              <h2
                className="font-display font-extrabold leading-tight text-white mb-4"
                style={{ fontSize: "clamp(1.8rem, 4vw, 2.8rem)" }}
              >
                Book Your First Pickup
                <br />
                <span style={{ color: "#a8dbf8" }}>Free of Charge</span>
              </h2>

              <p className="text-[15px] font-medium text-white/75 leading-relaxed max-w-md">
                New customers get their first pickup delivery fee waived.
                Experience premium laundry service risk-free.
              </p>
            </div>
